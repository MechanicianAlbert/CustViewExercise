...
public class LiquidDecorator implements IWaveDecorator {
    ...
    public InputSourceFeature[] getInputSourceFeatures() {
        int color1 = ResUtil.getColor(R.color.colorPinkLight);
        int color2 = ResUtil.getColor(R.color.colorPinkDark);
        int color3 = ResUtil.getColor(R.color.colorBlue);
        int color4 = ResUtil.getColor(R.color.colorPurple);
